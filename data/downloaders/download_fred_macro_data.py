...
from data.config.data_sources import FRED_SERIES, RAW_DATA_DIR, RESEARCH_START_DATE
...
for series_id, factor_name in FRED_SERIES.items():
    ...
    rows = fetch_fred_series(series_id, factor_name, RESEARCH_START_DATE)
...
combined_path = output_dir / "fred_macro_combined.csv"
